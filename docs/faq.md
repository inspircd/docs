...
These prefixes are provided by [the customprefix module](/4/modules/customprefix). You should load this module and then define the appropriate `<customprefix>` tags to add those prefixes.
...
- Giving server operators a channel status using [the operprefix module](/4/modules/operprefix).

- Overriding your lack of privileges using [the override module](/4/modules/override).

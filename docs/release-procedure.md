...
0. Post a link to the news post on the [InspIRCd Twitter account](https://twitter.com/InspIRCdTeam), [InspIRCd Mastodon account](https://fosstodon.org/@inspircd), [InspIRCd Cohost account](https://cohost.org/inspircd) and, if notable, on [/r/irc](https://old.reddit.com/r/irc/).

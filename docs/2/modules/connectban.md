...
This module zlines IP addresses which make excessive connections to the server.
...
ipv4cidr    | Number   | 32            | The IPv6 CIDR range to treat as equivalent when looking for excessive connections.

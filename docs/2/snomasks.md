...
This page only lists core snomasks. For details on the snomasks of a specific module please refer to [the appropriate page for that module](/2/modules).
...
d         | Various debug information. You probably don't want to use this.
f         | Notifications about users being killed for flooding the local server.

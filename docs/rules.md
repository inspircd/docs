...
* Well-behaved bots are allowed but must not speak unless spoken to and must not be used for breaking these rules, ban evasion, public logging, or training AI models. You should mark your bot using user mode +B (bot) if possible.
